...
<!--hxsglxiangdxongjxs-->
  ...
  <form name="form1" id="form1" method="post" action="">
   搜索:  编号：<input name="bianhao" type="text" id="bianhao" style='border:solid 1px #000000; color:#666666' size="12" />  科目名称：<%=Info.getselect("kemumingcheng","kemuxinxi","kemumingcheng"," 1=1 ")%> 答案：<select name='daan' id='daan' style='border:solid 1px #000000; color:#666666;'><option value="">所有</option><option value="对">对</option><option value="错">错</option></select>
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='panduanti_listxls.jsp';" />
</form>
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="panduanti_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="panduanti_list.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <a href="panduanti_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
