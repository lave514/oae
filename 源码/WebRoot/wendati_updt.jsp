...
//wxfladd
new CommDAO().update(request,response,"wendati",ext,true,false,""); 
HashMap mmm = new CommDAO().getmap(id,"wendati"); 
//lixanxdoxngcxhaxifxen
%>
  <form  action="wendati_updt.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改问答题:
  <br><br>
